...
public class Player : MonoBehaviour
{
    ...
    private void SetUpMoveBoundaries()
    {
        ...
        xMin = gameCamera.ViewportToWorldPoint(new Vector3(0, 0, 0)).x + padding + 5;
        xMax = gameCamera.ViewportToWorldPoint(new Vector3(1, 0, 0)).x - padding - 5;

        //set the boundaries on the y-axis
        yMin = gameCamera.ViewportToWorldPoint(new Vector3(0, 0, 0)).y + padding;
        yMax = gameCamera.ViewportToWorldPoint(new Vector3(0, 1, 0)).y - padding - 7;
    }
